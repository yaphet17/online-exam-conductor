...
$query="SELECT firstName,lastName,password,email FROM conductor WHERE username='".$conductorId."' LIMIT 1";
$result=mysqli_query($con,$query) or die('Error to send query');
$row=mysqli_fetch_assoc($result) or die('Error to fetch query');
$conductorName=$row['firstName']." ".$row['lastName'];
$email=$row['email'];
                                        ...
                                        <div class="row clearfix">
                                          <form action="<?=$_SERVER['PHP_SELF']?>" method='POST'>
                                              ...
                                              echo "<div class='col-lg-4 col-md-12'>
                                                  ...
                                                  <input type='text' class='form-control' value='".$conductorId."'placeholder='Username' disabled>
                                                  </div>
                                                  </div>"; ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    if(isset($_POST['save'])){
                                                      if(password_verify($_POST['oldPass'],$row['password'])){
                                                        ...
                                                        $query3="UPDATE conductor SET password='".$hashed."',email='".$newEmail."' WHERE username='".$conductorId."'";
