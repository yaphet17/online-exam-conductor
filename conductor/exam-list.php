...
<body>
  ...
  while($examRow=mysqli_fetch_assoc($examResult)){
    ...
    echo "<tr><td><input type='checkbox' id='".$i."' name='".$examId."'></td><td><a href='exam-detail.php?examId=".$examRow['examId']."'>".$examRow['examTitle']."</td><td>".$examRow['examCreationDate']."</td><td>".$examRow['examDateTime']."</td><td>".$examRow['examDuration']."</td><td>".$examRow['examCode']."</td><td>".$examRow['examStatus']."</td><td><a href='".$str1."'>Start</a><i style='color:blue'>|</i><a href='".$str2."'>Suspend</a><i style='color:blue'>|</i><a href='".$str4."'>Unsuspend</a><i style='color:blue'>|</i><a href='".$str3."'>Cancel</a></td></tr>";
    $i++;
  }
  ?>
</table>
