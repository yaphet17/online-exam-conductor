...
//Ongoing exams
$ongoQuery="SELECT COUNT(*) AS ongo FROM examination WHERE conductorId='".$conductorId."' AND examStatus='started'";
$ongoResult=mysqli_query($con,$ongoQuery) or die('Error to send query');
$ongoRow=mysqli_fetch_assoc($ongoResult) or die('Error to fetch query');
$ongo=$ongoRow['ongo'];
//Canceled exams
$canQuery="SELECT COUNT(*) AS cancel FROM examination WHERE conductorId='".$conductorId."' AND examStatus='canceled' AND examDateTime='".$currDateTime."'";
...
//Suspended exams
$susQuery="SELECT COUNT(*) AS suspend FROM examination WHERE conductorId='".$conductorId."' AND examStatus='suspended' AND examDateTime='".$currDateTime."'";
...
$todayEQuery="SELECT COUNT(*) AS today FROM examination WHERE conductorId='".$conductorId."' AND examDateTime='".$currDateTime."'";
...
$onexQuery="SELECT COUNT(*) AS onex FROM examenrollment ee,examination e WHERE e.examId=ee.examId AND e.conductorId='".$conductorId."' AND ee.attendanceStatus='attending'";
$onexResult=mysqli_query($con,$onexQuery) or die('Error to send query');
$onexRow=mysqli_fetch_assoc($onexResult) or die('Error to fetch query');
$onex=$onexRow['onex'];
//Dispelled candidates
$dispellQuery="SELECT COUNT(*) AS dispell FROM examenrollment ee,examination e WHERE e.examId=ee.examId AND e.conductorId='".$conductorId."' AND ee.attendanceStatus='dispelled'";
...
//Upcoming exams
$upexQuery="SELECT COUNT(*) AS upex FROM examination WHERE conductorId='".$conductorId."' AND examDateTime='".$currDateTime."'";
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <table class="table card-table mt-2">
                                <tbody>
                                      <?php
                                      $ongoingQuery="SELECT examTitle,examDateTime,examDuration FROM examination WHERE conductorId='".$conductorId."' AND examStatus='started' ORDER BY examDateTime DESC LIMIT 10";
