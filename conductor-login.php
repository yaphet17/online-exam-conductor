            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    if(isset($_POST['signin'])){
                      ...
                      $query="SELECT username,password,email FROM conductor WHERE username='".$uName."' OR email='".$uName."' LIMIT 1";
                      $result=mysqli_query($con,$query) or die("Error to send query");
                      $numRows=mysqli_num_rows($result) or die("Error count number of row");
                      if($numRows!=0){
                        ...
                        if(password_verify($pass,$row['password'])){
                            ...
                            header('Location: condutor-dashboard.php');
